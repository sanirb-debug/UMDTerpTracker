 ...
 */var Vs;function dA(){if(Vs)return z;Vs=1;var u=Symbol.for("react.element"),A=Symbol.for("react.portal"),a=Symbol.for("react.fragment"),O=Symbol.for("react.strict_mode"),N=Symbol.for("react.profiler"),G=Symbol.for("react.provider"),L=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),Y=Symbol.for("react.suspense"),F=Symbol.for("react.memo"),J=Symbol.for("react.lazy"),V=Symbol.iterator;function j(C){return C===null||typeof C!="object"?null:(C=V&&C[V]||C["@@iterator"],typeof C=="function"?C:null)}var de={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ue=Object.assign,D={};function g(C,T,W){this.props=C,this.context=T,this.refs=D,this.updater=W||de}g.prototype.isReactComponent={},g.prototype.setState=function(C,T){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,T,"setState")},g.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function $(){}$.prototype=g.prototype;function Ne(C,T,W){this.props=C,this.context=T,this.refs=D,this.updater=W||de}var Fe=Ne.prototype=new $;Fe.constructor=Ne,ue(Fe,g.prototype),Fe.isPureReactComponent=!0;var re=Array.isArray,ve=Object.prototype.hasOwnProperty,ie={current:null},Be={key:!0,ref:!0,__self:!0,__source:!0};function qe(C,T,W){var K,X={},Z=null,le=null;if(T!=null)for(K in T.ref!==void 0&&(le=T.ref),T.key!==void 0&&(Z=""+T.key),T)ve.call(T,K)&&!Be.hasOwnProperty(K)&&(X[K]=T[K]);var ne=arguments.length-2;if(ne===1)X.children=W;else if(1<ne){for(var Se=Array(ne),Je=0;Je<ne;Je++)Se[Je]=arguments[Je+2];X.children=Se}if(C&&C.defaultProps)for(K in ne=C.defaultProps,ne)X[K]===void 0&&(X[K]=ne[K]);return{$$typeof:u,type:C,key:Z,ref:le,props:X,_owner:ie.current}}function Un(C,T){return{$$typeof:u,type:C.type,key:T,ref:C.ref,props:C.props,_owner:C._owner}}function mn(C){return typeof C=="object"&&C!==null&&C.$$typeof===u}function $n(C){var T={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(W){return T[W]})}var dn=/\/+/g;function je(C,T){return typeof C=="object"&&C!==null&&C.key!=null?$n(""+C.key):T.toString(36)}function rn(C,T,W,K,X){var Z=typeof C;(Z==="undefined"||Z==="boolean")&&(C=null);var le=!1;if(C===null)le=!0;else switch(Z){case"string":case"number":le=!0;break;case"object":switch(C.$$typeof){case u:case A:le=!0}}if(le)return le=C,X=X(le),C=K===""?"."+je(le,0):K,re(X)?(W="",C!=null&&(W=C.replace(dn,"$&/")+"/"),rn(X,T,W,"",function(Je){return Je})):X!=null&&(mn(X)&&(X=Un(X,W+(!X.key||le&&le.key===X.key?"":(""+X.key).replace(dn,"$&/")+"/")+C)),T.push(X)),1;if(le=0,K=K===""?".":K+":",re(C))for(var ne=0;ne<C.length;ne++){Z=C[ne];var Se=K+je(Z,ne);le+=rn(Z,T,W,Se,X)}else if(Se=j(C),typeof Se=="function")for(C=Se.call(C),ne=0;!(Z=C.next()).done;)Z=Z.value,Se=K+je(Z,ne++),le+=rn(Z,T,W,Se,X);else if(Z==="object")throw T=String(C),Error("Objects are not valid as a React child (found: "+(T==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":T)+"). If you meant to render a collection of children, use an array instead.");return le}function Cn(C,T,W){if(C==null)return C;var K=[],X=0;return rn(C,K,"","",function(Z){return T.call(W,Z,X++)}),K}function Ye(C){if(C._status===-1){var T=C._result;T=T(),T.then(function(W){(C._status===0||C._status===-1)&&(C._status=1,C._result=W)},function(W){(C._status===0||C._status===-1)&&(C._status=2,C._result=W)}),C._status===-1&&(C._status=0,C._result=T)}if(C._status===1)return C._result.default;throw C._result}var ce={current:null},U={transition:null},Q={ReactCurrentDispatcher:ce,ReactCurrentBatchConfig:U,ReactCurrentOwner:ie};function H(){throw Error("act(...) is not supported in production builds of React.")}return z.Children={map:Cn,forEach:function(C,T,W){Cn(C,function(){T.apply(this,arguments)},W)},count:function(C){var T=0;return Cn(C,function(){T++}),T},toArray:function(C){return Cn(C,function(T){return T})||[]},only:function(C){if(!mn(C))throw Error("React.Children.only expected to receive a single React element child.");return C}},z.Component=g,z.Fragment=a,z.Profiler=N,z.PureComponent=Ne,z.StrictMode=O,z.Suspense=Y,z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Q,z.act=H,z.cloneElement=function(C,T,W){if(C==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+C+".");var K=ue({},C.props),X=C.key,Z=C.ref,le=C._owner;if(T!=null){if(T.ref!==void 0&&(Z=T.ref,le=ie.current),T.key!==void 0&&(X=""+T.key),C.type&&C.type.defaultProps)var ne=C.type.defaultProps;for(Se in T)ve.call(T,Se)&&!Be.hasOwnProperty(Se)&&(K[Se]=T[Se]===void 0&&ne!==void 0?ne[Se]:T[Se])}var Se=arguments.length-2;if(Se===1)K.children=W;else if(1<Se){ne=Array(Se);for(var Je=0;Je<Se;Je++)ne[Je]=arguments[Je+2];K.children=ne}return{$$typeof:u,type:C.type,key:X,ref:Z,props:K,_owner:le}},z.createContext=function(C){return C={$$typeof:L,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},C.Provider={$$typeof:G,_context:C},C.Consumer=C},z.createElement=qe,z.createFactory=function(C){var T=qe.bind(null,C);return T.type=C,T},z.createRef=function(){return{current:null}},z.forwardRef=function(C){return{$$typeof:f,render:C}},z.isValidElement=mn,z.lazy=function(C){return{$$typeof:J,_payload:{_status:-1,_result:C},_init:Ye}},z.memo=function(C,T){return{$$typeof:F,type:C,compare:T===void 0?null:T}},z.startTransition=function(C){var T=U.transition;U.transition={};try{C()}finally{U.transition=T}},z.unstable_act=H,z.useCallback=function(C,T){return ce.current.useCallback(C,T)},z.useContext=function(C){return ce.current.useContext(C)},z.useDebugValue=function(){},z.useDeferredValue=function(C){return ce.current.useDeferredValue(C)},z.useEffect=function(C,T){return ce.current.useEffect(C,T)},z.useId=function(){return ce.current.useId()},z.useImperativeHandle=function(C,T,W){return ce.current.useImperativeHandle(C,T,W)},z.useInsertionEffect=function(C,T){return ce.current.useInsertionEffect(C,T)},z.useLayoutEffect=function(C,T){return ce.current.useLayoutEffect(C,T)},z.useMemo=function(C,T){return ce.current.useMemo(C,T)},z.useReducer=function(C,T,W){return ce.current.useReducer(C,T,W)},z.useRef=function(C){return ce.current.useRef(C)},z.useState=function(C){return ce.current.useState(C)},z.useSyncExternalStore=function(C,T,W){return ce.current.useSyncExternalStore(C,T,W)},z.useTransition=function(){return ce.current.useTransition()},z.version="18.3.1",z}var Qs;function wl(){return Qs||(Qs=1,Fl.exports=dA()),Fl.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _s;function CA(){if(_s)return mt;_s=1;var u=wl(),A=Symbol.for("react.element"),a=Symbol.for("react.fragment"),O=Object.prototype.hasOwnProperty,N=u.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,G={key:!0,ref:!0,__self:!0,__source:!0};function L(f,Y,F){var J,V={},j=null,de=null;F!==void 0&&(j=""+F),Y.key!==void 0&&(j=""+Y.key),Y.ref!==void 0&&(de=Y.ref);for(J in Y)O.call(Y,J)&&!G.hasOwnProperty(J)&&(V[J]=Y[J]);if(f&&f.defaultProps)for(J in Y=f.defaultProps,Y)V[J]===void 0&&(V[J]=Y[J]);return{$$typeof:A,type:f,key:j,ref:de,props:V,_owner:N.current}}return mt.Fragment=a,mt.jsx=L,mt.jsxs=L,mt}var js;function EA(){return js||(js=1,yl.exports=CA()),yl.exports}var m=EA(),ee=wl(),Hr={},Bl={exports:{}},_e={},Yl={exports:{}},xl={};/**
 * @license React
...
`,Kn=[{slug:"information-science",name:"Information Science",short:"InfoSci",hasRequirements:!0},{slug:"computer-science",name:"Computer Science",short:"CS",hasRequirements:!0},{slug:"management",name:"Management",short:"Mgmt",hasRequirements:!0},{slug:"finance",name:"Finance",short:"Finance",hasRequirements:!0},{slug:"information-systems",name:"Information Systems",short:"Info Sys",hasRequirements:!0},{slug:"psychology",name:"Psychology",short:"Psych",hasRequirements:!1},{slug:"criminology",name:"Criminology and Criminal Justice",short:"CCJS",hasRequirements:!1},{slug:"economics",name:"Economics",short:"Econ",hasRequirements:!1},{slug:"biology",name:"Biological Sciences",short:"Biology",hasRequirements:!1},{slug:"government",name:"Government and Politics",short:"GVPT",hasRequirements:!1},{slug:"mechanical-engineering",name:"Mechanical Engineering",short:"Mech E",hasRequirements:!1},{slug:"communication",name:"Communication",short:"Comm",hasRequirements:!1},{slug:"kinesiology",name:"Kinesiology",short:"Kines",hasRequirements:!1}],ft=[{slug:"freshman",label:"Freshman"},{slug:"sophomore",label:"Sophomore"},{slug:"junior",label:"Junior"},{slug:"senior",label:"Senior"}],su=[{id:"sample-information-science-freshman",major:"information-science",year:"freshman",text:A1},{id:"sample-information-science-sophomore",major:"information-science",year:"sophomore",text:d1},{id:"sample-information-science-junior",major:"information-science",year:"junior",text:C1},{id:"sample-information-science-senior",major:"information-science",year:"senior",text:E1},{id:"sample-computer-science-freshman",major:"computer-science",year:"freshman",text:c1},{id:"sample-computer-science-sophomore",major:"computer-science",year:"sophomore",text:I1},{id:"sample-computer-science-junior",major:"computer-science",year:"junior",text:N1},{id:"sample-computer-science-senior",major:"computer-science",year:"senior",text:O1},{id:"sample-management-freshman",major:"management",year:"freshman",text:m1},{id:"sample-management-sophomore",major:"management",year:"sophomore",text:f1},{id:"sample-management-junior",major:"management",year:"junior",text:R1},{id:"sample-management-senior",major:"management",year:"senior",text:T1},{id:"sample-finance-freshman",major:"finance",year:"freshman",text:p1},{id:"sample-finance-sophomore",major:"finance",year:"sophomore",text:P1},{id:"sample-finance-junior",major:"finance",year:"junior",text:M1},{id:"sample-finance-senior",major:"finance",year:"senior",text:G1},{id:"sample-information-systems-freshman",major:"information-systems",year:"freshman",text:L1},{id:"sample-information-systems-sophomore",major:"information-systems",year:"sophomore",text:U1},{id:"sample-information-systems-junior",major:"information-systems",year:"junior",text:D1},{id:"sample-information-systems-senior",major:"information-systems",year:"senior",text:h1},{id:"sample-psychology-freshman",major:"psychology",year:"freshman",text:g1},{id:"sample-psychology-sophomore",major:"psychology",year:"sophomore",text:v1},{id:"sample-psychology-junior",major:"psychology",year:"junior",text:H1},{id:"sample-psychology-senior",major:"psychology",year:"senior",text:y1},{id:"sample-criminology-freshman",major:"criminology",year:"freshman",text:F1},{id:"sample-criminology-sophomore",major:"criminology",year:"sophomore",text:B1},{id:"sample-criminology-junior",major:"criminology",year:"junior",text:Y1},{id:"sample-criminology-senior",major:"criminology",year:"senior",text:x1},{id:"sample-economics-freshman",major:"economics",year:"freshman",text:w1},{id:"sample-economics-sophomore",major:"economics",year:"sophomore",text:k1},{id:"sample-economics-junior",major:"economics",year:"junior",text:V1},{id:"sample-economics-senior",major:"economics",year:"senior",text:Q1},{id:"sample-biology-freshman",major:"biology",year:"freshman",text:_1},{id:"sample-biology-sophomore",major:"biology",year:"sophomore",text:j1},{id:"sample-biology-junior",major:"biology",year:"junior",text:J1},{id:"sample-biology-senior",major:"biology",year:"senior",text:W1},{id:"sample-government-freshman",major:"government",year:"freshman",text:z1},{id:"sample-government-sophomore",major:"government",year:"sophomore",text:K1},{id:"sample-government-junior",major:"government",year:"junior",text:$1},{id:"sample-government-senior",major:"government",year:"senior",text:q1},{id:"sample-mechanical-engineering-freshman",major:"mechanical-engineering",year:"freshman",text:X1},{id:"sample-mechanical-engineering-sophomore",major:"mechanical-engineering",year:"sophomore",text:Z1},{id:"sample-mechanical-engineering-junior",major:"mechanical-engineering",year:"junior",text:b1},{id:"sample-mechanical-engineering-senior",major:"mechanical-engineering",year:"senior",text:ed},{id:"sample-communication-freshman",major:"communication",year:"freshman",text:nd},{id:"sample-communication-sophomore",major:"communication",year:"sophomore",text:td},{id:"sample-communication-junior",major:"communication",year:"junior",text:rd},{id:"sample-communication-senior",major:"communication",year:"senior",text:id},{id:"sample-kinesiology-freshman",major:"kinesiology",year:"freshman",text:ld},{id:"sample-kinesiology-sophomore",major:"kinesiology",year:"sophomore",text:od},{id:"sample-kinesiology-junior",major:"kinesiology",year:"junior",text:ad},{id:"sample-kinesiology-senior",major:"kinesiology",year:"senior",text:sd}];function uu(u){return u?su.find(A=>A.id===u):void 0}function yr(u,A){return su.find(a=>a.major===u&&a.year===A)}function ud(u){const A=uu(u);return A?Kn.find(a=>a.slug===A.major):void 0}const Sd="https://github.com/sanirb-debug/UMDTerpTracker",Ad={matches:"Computed GPA matches the GPA printed on the transcript.",differs:"Computed GPA does NOT match the GPA printed on the transcript.","transcript-printed-none":"The transcript printed no cumulative GPA to compare against."};function dd(u){const A=`Something looks wrong on the ${u.view} view`,O=["Reporting something that looks wrong. I haven't described the problem yet — adding that below.","","## What I was doing","",`- View: ${u.view}`,`- Data: ${u.source==="sample"?`demo sample \`${u.sampleId??"unknown"}\``:"my own uploaded transcript"}`,"","## What the app reported","",`- Parse warnings: ${u.warningCodes.length>0?u.warningCodes.join(", "):"none"}`,`- ${Ad[u.gpaCheck]}`,"","## What went wrong","","<!-- Please describe what you expected and what you saw. -->","","---","","This report was prefilled by TerpTracker and deliberately contains no","transcript contents: no courses, grades, credits, GPA values, name or","student ID. Please do not paste any of those into a public issue."].join(`
`),N=`${Sd}/issues/new?title=${encodeURIComponent(A)}&body=${encodeURIComponent(O)}`;return{title:A,body:O,url:N}}function Cd(u){const{view:A,transcript:a,sampleId:O}=u;if(!a)return{view:A,source:O?"sample":"upload",...O?{sampleId:O}:{},warningCodes:[],gpaCheck:"transcript-printed-none"};const N=Vl(a),G=N.statedGpa===null?"transcript-printed-none":N.ok?"matches":"differs";return{view:A,source:O?"sample":"upload",...O?{sampleId:O}:{},warningCodes:[...new Set(a.warnings.map(L=>L.code))],gpaCheck:G}}function Ed({view:u,transcript:A,sampleId:a,className:O}){const[N,G]=ee.useState(!1),L=ee.useMemo(()=>dd(Cd({view:u,transcript:A,sampleId:a})),[u,A,a]);return N?m.jsxs("div",{className:"mt-2 w-full rounded-lg border border-neutral-300 p-3 text-left dark:border-neutral-700",children:[m.jsx("h3",{className:"text-sm font-semibold",children:"This is exactly what will be sent"}),m.jsx("p",{className:"mt-1 text-xs text-neutral-600 dark:text-neutral-300",children:"It opens a public GitHub issue in a new tab, prefilled with the text below and nothing else. No part of your transcript is included — no courses, grades, GPA, name or student ID. Please keep it that way when you add your description."}),m.jsx("p",{className:"mt-3 text-[10px] font-semibold uppercase tracking-wide text-neutral-500",children:"Title"}),m.jsx("pre",{className:"mt-1 overflow-x-auto whitespace-pre-wrap rounded bg-neutral-100 p-2 text-xs dark:bg-neutral-950",children:L.title}),m.jsx("p",{className:"mt-2 text-[10px] font-semibold uppercase tracking-wide text-neutral-500",children:"Body"}),m.jsx("pre",{className:"mt-1 max-h-56 overflow-auto whitespace-pre-wrap rounded bg-neutral-100 p-2 text-xs dark:bg-neutral-950",children:L.body}),m.jsxs("div",{className:"mt-3 flex flex-wrap items-center gap-2",children:[m.jsx("a",{className:"button text-xs",href:L.url,target:"_blank",rel:"noopener noreferrer",onClick:()=>G(!1),children:"Open GitHub issue"}),m.jsx("button",{type:"button",className:"button-quiet text-xs",onClick:()=>G(!1),children:"Cancel"})]})]}):m.jsx("button",{type:"button",onClick:()=>G(!0),className:`inline-flex min-h-11 items-center text-xs text-neutral-500 underline decoration-dotted underline-offset-2 hover:text-neutral-900 sm:min-h-0 dark:hover:text-neutral-100 ${O??""}`,children:"Something looks wrong"})}function Fr(u){return typeof u=="string"&&u.trim().length>0}function cd(u){const A=[];return Fr(u.text)||A.push("text"),Fr(u.speaker)||A.push("speaker"),Fr(u.sourceUrl)||A.push("sourceUrl"),A.length===0?null:`missing ${A.join(", ")}`}function Id(u,A){const a=u==null?void 0:u.quotes;if(!Array.isArray(a))return[];const O=[];return a.forEach((N,G)=>{cd(N??{})===null&&O.push({text:N.text.trim(),speaker:N.speaker.trim(),...Fr(N.context)?{context:N.context.trim()}:{},sourceUrl:N.sourceUrl.trim()})}),O}function Nd(u,A,a=Math.random){if(u.length===0)return null;const O=u.length>1?u.filter(N=>N!==A):u;return O[Math.min(O.length-1,Math.floor(a()*O.length))]}const Od=[{text:"",speaker:"",context:"",sourceUrl:""}],md={quotes:Od},fd=Id(md);function Rd({quotes:u=fd,random:A}){const[a,O]=ee.useState(null),N=ee.useRef(null),G=ee.useRef(null),L=ee.useCallback(()=>{var f;O(null),(f=N.current)==null||f.focus()},[]);return ee.useEffect(()=>{if(!a)return;const f=Y=>{Y.key==="Escape"&&L()};return document.addEventListener("keydown",f),()=>document.removeEventListener("keydown",f)},[a,L]),u.length===0?null:m.jsxs("div",{className:"pad-safe-bottom pointer-events-none fixed inset-x-0 bottom-0 z-40 flex flex-col items-end gap-2 pr-3 sm:inset-x-auto sm:right-3 sm:pb-3",children:[a&&m.jsxs("blockquote",{id:"testudo-quote",className:"pointer-events-auto max-w-xs rounded-xl border border-neutral-300 bg-white p-3 text-left shadow-lg dark:border-neutral-700 dark:bg-neutral-900",children:[m.jsx("p",{className:"text-sm",children:a.text}),m.jsxs("footer",{className:"mt-2 text-xs text-neutral-500 dark:text-neutral-400",children:[m.jsx("cite",{className:"not-italic font-medium text-neutral-700 dark:text-neutral-200",children:a.speaker}),a.context&&m.jsxs("span",{children:[" — ",a.context]})," ",m.jsx("a",{className:"underline",href:a.sourceUrl,target:"_blank",rel:"noopener noreferrer",children:"source"})]})]}),m.jsx("button",{ref:N,type:"button","aria-label":a?"Hide the quote about Maryland":"Testudo has something to say about Maryland","aria-expanded":a!==null,"aria-controls":a?"testudo-quote":void 0,onClick:()=>O(f=>{if(f)return null;const Y=Nd(u,G.current??void 0,A);return G.current=Y,Y}),className:"pointer-events-auto flex h-11 w-11 items-center justify-center rounded-full text-lg leading-none opacity-30 transition-opacity hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terp-red sm:h-8 sm:w-8",children:m.jsx("span",{"aria-hidden":"true",children:"🐢"})})]})}class Td extends Error{constructor(){super("This PDF has no text in it, so it looks like a scan or a photo. Download the unofficial transcript straight from Testudo instead of scanning a printout."),this.name="ScannedPdfError"}}function pd({transcript:u,sampleId:A,onParsed:a,onForget:O}){const[N,G]=ee.useState(null),[L,f]=ee.useState(!1),[Y,F]=ee.useState(null),[J,V]=ee.useState(!1),j=ee.useRef(null),de=ee.useCallback(async D=>{G(null),f(!0),F({phase:"reading"});try{const{parseTranscriptFile:g}=await Tt(async()=>{const{parseTranscriptFile:Ne}=await import("./client-L6uYVu2n.js");return{parseTranscriptFile:Ne}},[]),$=await g(D,F);if($.terms.length===0){G("No semesters turned up in that PDF. Make sure it is the unofficial transcript from Testudo.");return}a($)}catch(g){G(g instanceof Td?g.message:`That PDF could not be read. ${g instanceof Error?g.message:""}`.trim())}finally{f(!1),F(null)}},[a]),ue=ee.useCallback((D,g)=>{G(null),a(au(g),D)},[a]);return m.jsxs("div",{className:"space-y-6",children:[m.jsxs("section",{onDragOver:D=>{D.preventDefault(),V(!0)},onDragLeave:()=>V(!1),onDrop:D=>{D.preventDefault(),V(!1);const g=D.dataTransfer.files[0];g&&de(g)},className:`rounded-xl border p-5 text-center transition-colors sm:border-2 sm:border-dashed sm:p-10 ${J?"border-terp-red bg-red-50 dark:bg-red-950/20":"border-neutral-200 dark:border-neutral-800 sm:border-neutral-300 sm:dark:border-neutral-700"}`,children:[m.jsxs("p",{className:"mb-1 text-lg font-semibold",children:[m.jsx("span",{className:"sm:hidden",children:"Add your unofficial transcript"}),m.jsx("span",{className:"hidden sm:inline",children:"Drop your unofficial transcript here"})]}),m.jsx("p",{className:"mb-5 text-sm text-neutral-500 dark:text-neutral-400",children:"Testudo → Academics → Unofficial Transcript → save as PDF"}),m.jsx("input",{ref:j,id:"transcript-file",type:"file",accept:"application/pdf,.pdf",className:"sr-only",disabled:L,onChange:D=>{var $;const g=($=D.target.files)==null?void 0:$[0];g&&de(g),D.target.value=""}}),L?m.jsx(Pd,{progress:Y}):m.jsx("label",{htmlFor:"transcript-file",className:"button w-full cursor-pointer text-base focus-within:ring-2 focus-within:ring-terp-red focus-within:ring-offset-2 sm:w-auto sm:text-sm dark:focus-within:ring-offset-neutral-950",children:"Choose file"}),m.jsx("p",{className:"mt-3 hidden text-xs text-neutral-500 sm:block dark:text-neutral-400",children:"or drag it onto this box"})]}),m.jsxs("section",{className:"card",children:[m.jsx("h2",{className:"font-semibold",children:"See how it works"}),m.jsx("p",{className:"mt-1 text-sm text-neutral-600 dark:text-neutral-300",children:"Rather not hand your transcript to a site you have never heard of? Reasonable. Pick a major and a year — no file, no upload."}),m.jsx(Md,{sampleId:A,onLoad:ue}),m.jsx("div",{className:"mt-4 hidden overflow-x-auto sm:block",children:m.jsxs("table",{className:"w-full border-separate border-spacing-1 text-sm",children:[m.jsx("caption",{className:"sr-only",children:"Sample transcripts by major and class year. Majors marked “no audit” have no degree requirements on file."}),m.jsx("thead",{children:m.jsxs("tr",{children:[m.jsx("th",{className:"sticky left-0 z-10 w-24 bg-white dark:bg-neutral-900"}),Kn.map(D=>m.jsxs("th",{scope:"col",className:"px-1 pb-1 align-bottom",children:[m.jsx("span",{className:"block whitespace-nowrap text-xs font-semibold",children:D.short}),m.jsx("span",{className:`block whitespace-nowrap text-[10px] font-normal ${D.hasRequirements?"text-emerald-600 dark:text-emerald-400":"text-neutral-400 dark:text-neutral-500"}`,children:D.hasRequirements?"audit":"no audit"})]},D.slug))]})}),m.jsx("tbody",{children:ft.map(D=>m.jsxs("tr",{children:[m.jsx("th",{scope:"row",className:"sticky left-0 z-10 bg-white pr-2 text-right text-xs font-medium text-neutral-500 dark:bg-neutral-900",children:D.label}),Kn.map(g=>{const $=yr(g.slug,D.slug);if(!$)return m.jsx("td",{},g.slug);const Ne=$.id===A;return m.jsx("td",{className:"p-0",children:m.jsx("button",{type:"button",onClick:()=>ue($.id,$.text),"aria-current":Ne?"true":void 0,"aria-label":`${g.name}, ${D.label}${g.hasRequirements?"":" (no degree audit available)"}`,className:`w-full whitespace-nowrap rounded border px-3 py-2 text-xs transition-colors hover:border-terp-red ${Ne?"border-terp-red bg-red-50 font-semibold dark:bg-red-950/20":g.hasRequirements?"border-emerald-500/40 dark:border-emerald-500/30":"border-dashed border-neutral-300 dark:border-neutral-700"}`,children:D.label})},g.slug)})]},D.slug))})]})}),m.jsx("p",{className:"mt-3 hidden text-xs text-neutral-500 sm:block dark:text-neutral-400",children:"Solid columns have degree requirements on file and produce a full audit. Dashed ones do not — everything else works, but the audit page says so instead of guessing. Requirements are transcribed from the catalog by hand, one major at a time."}),m.jsx("p",{className:"mt-3 text-xs text-neutral-500 sm:hidden dark:text-neutral-400",children:"Majors marked “no audit” have no degree requirements on file — everything else works, but the audit page says so instead of guessing. Requirements are transcribed from the catalog by hand, one major at a time."}),m.jsx("p",{className:"mt-2 text-xs text-neutral-500 dark:text-neutral-400",children:"Each major is one invented student across four years, so later years contain everything the earlier ones do. Entirely synthetic; no real transcript is in this repository."})]}),N&&m.jsxs("section",{role:"alert",className:"rounded-lg border border-red-300 bg-red-50 p-4 text-sm text-red-800 dark:border-red-900 dark:bg-red-950/40 dark:text-red-200",children:[m.jsx("h2",{className:"font-semibold",children:"That did not work"}),m.jsx("p",{className:"mt-1",children:N}),m.jsx("p",{className:"mt-2 text-xs text-red-700 dark:text-red-300",children:"Nothing was kept and nothing was sent anywhere. Pick another file and try again, or use a sample above to see what the app does."})]}),m.jsxs("section",{className:"card space-y-2 text-sm",children:[m.jsx("h2",{className:"font-semibold",children:"Where your transcript goes"}),m.jsx("p",{className:"text-neutral-600 dark:text-neutral-300",children:"Nowhere. The PDF is read by JavaScript running in this tab. There is no server, no account and no upload — the file never leaves your device, and you can check that in your browser's network tab."}),m.jsx("p",{className:"text-neutral-600 dark:text-neutral-300",children:"The parsed result is kept in this browser's local storage so you do not have to re-upload every visit. Clearing it removes every trace."}),u&&m.jsx("button",{type:"button",className:"button-quiet mt-2",onClick:O,children:A?"Clear the sample":"Clear my transcript"})]})]})}function Pd({progress:u}){const A=(u==null?void 0:u.phase)==="parsing"?`Reading page ${u.page} of ${u.totalPages}…`:"Opening your transcript…";return m.jsxs("div",{role:"status",className:"flex min-h-11 items-center justify-center gap-3 text-sm text-neutral-600 dark:text-neutral-300",children:[m.jsx("span",{"aria-hidden":"true",className:"h-5 w-5 animate-spin rounded-full border-2 border-neutral-300 border-t-terp-red dark:border-neutral-700 dark:border-t-terp-red"}),A]})}function Md({sampleId:u,onLoad:A}){const[a,O]=ee.useState(()=>{const F=Kn.find(J=>ft.some(V=>{var j;return((j=yr(J.slug,V.slug))==null?void 0:j.id)===u}));return(F==null?void 0:F.slug)??Kn[0].slug}),[N,G]=ee.useState(()=>{var F;return((F=ft.find(J=>{var V;return((V=yr(a,J.slug))==null?void 0:V.id)===u}))==null?void 0:F.slug)??ft[0].slug}),L=Kn.find(F=>F.slug===a)??Kn[0],f=yr(a,N),Y=f!=null&&f.id===u;return m.jsxs("div",{className:"mt-4 space-y-3 sm:hidden",children:[m.jsxs("label",{className:"block",children:[m.jsx("span",{className:"label",children:"Major"}),m.jsx("select",{className:"select mt-1",value:a,onChange:F=>O(F.target.value),children:Kn.map(F=>m.jsxs("option",{value:F.slug,children:[F.name,F.hasRequirements?"":" (no audit)"]},F.slug))})]}),m.jsxs("label",{className:"block",children:[m.jsx("span",{className:"label",children:"Class year"}),m.jsx("select",{className:"select mt-1",value:N,onChange:F=>G(F.target.value),children:ft.map(F=>m.jsx("option",{value:F.slug,children:F.label},F.slug))})]}),m.jsx("button",{type:"button",className:"button w-full",disabled:!f||Y,onClick:()=>f&&A(f.id,f.text),children:Y?"Showing this sample":"Load this sample"}),m.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:L.hasRequirements?`${L.name} has degree requirements on file, so this one produces a full audit.`:`${L.name} has no degree requirements on file yet — everything works except the audit page, which says so instead of guessing.`})]})}const Su=2,jl="terptracker.transcript.v1",Jl="terptracker.plan.v1";function Au(u){try{const A=window.localStorage.getItem(u);return A?JSON.parse(A):null}catch{return null}}function du(u,A){try{window.localStorage.setItem(u,JSON.stringify(A))}catch{}}function Gd(){const u=Au(jl);if(!u)return{transcript:null,stale:!1};const A=u;return typeof A.version!="number"||A.version!==Su?{transcript:null,sampleId:A.sampleId,stale:!0}:{transcript:A.transcript,sampleId:A.sampleId,stale:!1}}function bs(u,A){const a={version:Su,transcript:u};A&&(a.sampleId=A),du(jl,a)}const xd=()=>Au(Jl),wd=u=>du(Jl,u);function Ld(){try{window.localStorage.removeItem(jl),window.localStorage.removeItem(Jl),window.localStorage.removeItem("terptracker.isSample.v1")}catch{}}const Ud=ee.lazy(()=>Tt(()=>import("./Dashboard-BY_SCAkX.js"),__vite__mapDeps([0,1,2])).then(u=>({default:u.DashboardPage}))),Dd=ee.lazy(()=>Tt(()=>import("./Planner-BsWHlUlK.js"),__vite__mapDeps([3,2,4])).then(u=>({default:u.PlannerPage}))),hd=ee.lazy(()=>Tt(()=>import("./Schedule-DX4tYX3c.js"),__vite__mapDeps([5,1,4,2])).then(u=>({default:u.SchedulePage}))),gd=ee.lazy(()=>Tt(()=>import("./Requirements-DYbGBIOn.js"),__vite__mapDeps([6,2,4])).then(u=>({default:u.RequirementsPage}))),vd={dashboard:"Dashboard",requirements:"Requirements",schedule:"Schedule",planner:"Planner",upload:"Transcript"},Hd=[{id:"dashboard",label:"Dashboard"},{id:"requirements",label:"Requirements"},{id:"schedule",label:"Schedule"},{id:"planner",label:"Planner"},{id:"upload",label:"Transcript"}];function yd(){var de,ue,D;const[u,A]=ee.useState(null),[a,O]=ee.useState(void 0),[N,G]=ee.useState(!1),[L,f]=ee.useState("upload");ee.useEffect(()=>{const g=Gd();if(g.transcript){A(g.transcript),O(g.sampleId),f("dashboard");return}if(!g.stale)return;const $=uu(g.sampleId);if($){const Ne=au($.text);A(Ne),O($.id),bs(Ne,$.id),f("dashboard");return}G(!0)},[]);const Y=ee.useCallback((g,$)=>{A(g),O($),G(!1),bs(g,$),f("dashboard")},[]),F=ee.useCallback(()=>{Ld(),A(null),O(void 0),f("upload")},[]),J=ee.useMemo(()=>u?eu(u):null,[u]),V=ee.useMemo(()=>u?Vl(u):null,[u]),j=!!(V&&V.statedGpa!==null&&!V.ok);return m.jsxs("div",{className:"pad-safe-x mx-auto min-h-screen min-h-dvh max-w-4xl py-8",children:[m.jsxs("header",{className:"mb-4 flex flex-wrap items-start justify-between gap-3",children:[m.jsxs("div",{children:[m.jsxs("h1",{className:"text-2xl font-bold tracking-tight",children:["Terp",m.jsx("span",{className:"text-terp-red",children:"Tracker"})]}),m.jsxs("p",{className:"text-sm text-neutral-500 dark:text-neutral-400",children:[(u==null?void 0:u.major)??"Your transcript, your GPA, and what you need next"," — all in this tab."]})]}),(J==null?void 0:J.gpa)!=null&&m.jsxs("div",{className:"text-right",children:[m.jsxs("div",{className:`text-3xl font-bold tabular-nums ${j?"text-amber-600 dark:text-amber-400":""}`,children:[J.gpa.toFixed(3),j&&m.jsx("span",{className:"ml-1 align-top text-base",children:"⚠"})]}),m.jsxs("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:[J.earnedCredits," credits"]}),m.jsx(Ed,{view:vd[L],transcript:u,sampleId:a,className:"mt-1"})]})]}),m.jsxs("p",{className:"mb-4 rounded-lg border border-amber-400/60 bg-amber-50 px-3 py-2 text-sm text-amber-900 dark:border-amber-700/60 dark:bg-amber-950/30 dark:text-amber-200",children:[m.jsx("strong",{children:"Unofficial."})," Not affiliated with the University of Maryland. Confirm anything here with your advisor and your official degree audit before you register."]}),N&&m.jsxs("p",{role:"alert",className:"mb-4 rounded-lg border border-sky-400/60 bg-sky-50 px-3 py-2 text-sm text-sky-900 dark:border-sky-700/60 dark:bg-sky-950/30 dark:text-sky-200",children:[m.jsx("strong",{children:"TerpTracker got better at reading transcripts since you last used it."})," ","Your saved copy was read by the older version and would have shown requirements as unmet that you have actually finished, so it has been cleared. Drop your PDF in again to pick up the new checks — it only ever lived in this browser, so there is nothing to recover."]}),a&&m.jsxs("p",{className:"mb-4 rounded-lg border border-sky-400/60 bg-sky-50 px-3 py-2 text-sm text-sky-900 dark:border-sky-700/60 dark:bg-sky-950/30 dark:text-sky-200",children:["Sample data — an invented ",m.jsx("strong",{children:((de=ud(a))==null?void 0:de.name)??"demo"})," student, not your own record. Everything below is real behaviour on invented data; load your own transcript from the Transcript tab whenever you like."]}),j&&V&&m.jsxs("p",{role:"alert",className:"mb-4 rounded-lg border border-amber-500 bg-amber-100 px-3 py-2 text-sm text-amber-900 dark:border-amber-600 dark:bg-amber-950/50 dark:text-amber-100",children:[m.jsx("strong",{children:"This GPA does not match your transcript."})," We compute"," ",(ue=V.computedGpa)==null?void 0:ue.toFixed(3)," but your transcript prints ",(D=V.statedGpa)==null?void 0:D.toFixed(3),", so something did not parse correctly. Treat every number here as unreliable until it agrees."]}),m.jsx("nav",{className:"mb-6 flex flex-wrap gap-1 border-b border-neutral-200 dark:border-neutral-800 sm:flex-nowrap",children:Hd.map(({id:g,label:$})=>m.jsx("button",{type:"button",onClick:()=>f(g),disabled:g!=="upload"&&!u,"aria-current":L===g?"page":void 0,className:`-mb-px min-h-11 border-b-2 px-3 py-2 text-sm font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-40 sm:min-h-0 sm:px-4 ${L===g?"border-terp-red text-terp-red":"border-transparent text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:$},g))}),m.jsx("main",{children:m.jsxs(ee.Suspense,{fallback:m.jsx("p",{className:"text-sm text-neutral-500",children:"Loading…"}),children:[L==="upload"&&m.jsx(pd,{transcript:u,sampleId:a,onParsed:Y,onForget:F}),L==="dashboard"&&u&&m.jsx(Ud,{transcript:u}),L==="requirements"&&u&&m.jsx(gd,{transcript:u,sampleId:a}),L==="schedule"&&u&&m.jsx(hd,{transcript:u}),L==="planner"&&u&&m.jsx(Dd,{transcript:u})]})}),m.jsx("footer",{className:"mt-12 border-t border-neutral-200 pt-4 text-xs text-neutral-500 dark:border-neutral-800",children:"Course data from api.umd.io, grades and ratings from PlanetTerp. Both are run by students and volunteers, and both are cached here rather than called on your behalf."}),m.jsx(Rd,{})]})}const Cu=document.getElementById("root");if(!Cu)throw new Error("missing #root");fA.createRoot(Cu).render(m.jsx(ee.StrictMode,{children:m.jsx(yd,{})}));export{Yd as D,ru as G,Yr as P,Ed as S,Tt as _,UA as a,wd as b,eu as c,Td as d,iu as e,wA as f,Bd as g,YA as h,a1 as i,m as j,xd as l,s1 as p,ee as r,Vl as s,BA as w};
